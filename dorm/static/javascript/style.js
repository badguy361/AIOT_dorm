...
async function myAsyncFunction() {
    while (1) {
        ...
        fetch('http://140.115.200.38:80/dorm/getJsondata')
            ...
            .then((data) => {
                washingMachine_box1_usage = data[2]["fields"]['battery']
                washingMachine_1_usage = data[2]["fields"]['battery']
                shower_box1_usage = data[2]["fields"]['battery']
                shower_1_usage = data[2]["fields"]['battery']
                disabled_box1_usage = data[2]["fields"]['battery']
                disabled_1_usage = data[2]["fields"]['battery']
                dryerMachine_box1_usage = data[2]["fields"]['battery']
                dryerMachine_1_usage = data[2]["fields"]['battery']
                console.log(washingMachine_1_usage)
