        ...
        fetch('http://127.0.0.1:8000/dorm/getJsondata1')
            ...
            .then((data) => {
              //這部分不太確定哪個欄位從哪裡讀資料
                ...
                //下面的顏色動畫確定可以
                if (parseInt(f2washingMachine_box1_usage) > 10) {
                ...
                if (parseInt(f2washingMachine_box2_usage) > 10) {
                ...
                if (parseInt(f2shower_1_usage) > 10) {
                ...
                if (parseInt(f2shower_2_usage) > 10) {
                ...
                if (parseInt(f2shower_3_usage) > 10) {
                ...
                if (parseInt(f2shower_4_usage) > 10) {
                ...
                if (parseInt(f2shower_5_usage) > 10) {
                ...
                if (parseInt(f2shower_6_usage) > 10) {
                ...
                if (parseInt(f2disabled_1_usage) > 10) {
                ...
                if (parseInt(f2dryerMachine_1_usage) > 10) {
