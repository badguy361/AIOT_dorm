...
async function myAsyncFunction() {
    while (1) {
        ...
        fetch('http://127.0.0.1:8000/dorm/getJsondata3')
            ...
            .then((data) => {
                //這部分不太確定哪個欄位從哪裡讀資料
                f3dryerMachine_1_usage = data[0]["fields"]['facilities_useage'];
                f3washingMachine_box1_usage = data[1]["fields"]['facilities_useage'];
                f3washingMachine_box2_usage = data[2]["fields"]['facilities_useage'];
                f3disabled_1_usage = data[3]["fields"]['facilities_useage'];
                f3wc_1_usage = data[4]["fields"]['facilities_useage'];
                f3wc_2_usage = data[5]["fields"]['facilities_useage'];
                f3wc_3_usage = data[6]["fields"]['facilities_useage'];
                f3shower_1_usage = data[7]["fields"]['facilities_useage'];
                f3shower_2_usage = data[8]["fields"]['facilities_useage'];
                f3shower_3_usage = data[9]["fields"]['facilities_useage'];
                f3shower_4_usage = data[10]["fields"]['facilities_useage'];
                f3shower_5_usage = data[11]["fields"]['facilities_useage'];
                f3shower_6_usage = data[12]["fields"]['facilities_useage'];
                ...
                //下面的顏色動畫確定可以
                if (parseInt(f3washingMachine_box1_usage) > 0) {
                ...
                if (parseInt(f3washingMachine_box2_usage) > 0) {
                ...
                if (parseInt(f3shower_1_usage) > 0) {
                ...
                if (parseInt(f3shower_2_usage) > 0) {
                ...
                if (parseInt(f3shower_3_usage) > 0) {
                ...
                if (parseInt(f3shower_4_usage) > 0) {
                ...
                if (parseInt(f3shower_5_usage) > 0) {
                ...
                if (parseInt(f3shower_6_usage) > 0) {
                ...
                if (parseInt(f3disabled_1_usage) > 0) {
                ...
                if (parseInt(f3dryerMachine_1_usage) > 0) {
